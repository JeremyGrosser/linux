...
#define  APS_FSMCO_PFM_LDALL		BIT(0)
...
/*  RTL8814 GPIO2 LED Pins. */
#define  GPIO_IO_PINS_LED0          (BIT(0) | BIT(1) | BIT(5) | BIT(6))
...
#define  MCU_CPU_DL_READY		BIT(15)
#define  MCU_FW_DL_ROM_DL_ENABLE	BIT(19)
...
#define  FIFOPAGE_BEACON_VALID		BIT(15)
